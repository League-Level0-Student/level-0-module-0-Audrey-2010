...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// or a kick
			String kitKat = JOptionPane.showInputDialog("Would you like to attack the dragon with a yell or a kick?");
			// 4. If they typed in "yell":
			if (kitKat.equals("yell")) {
			...
			// dragon.
			JOptionPane.showMessageDialog(null, dragonHealth + " " + playerHealth);
